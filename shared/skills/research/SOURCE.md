...
- **Path in the repository:** `skills/engineering/research`
...
Short by design in the source: the skill is a three-step brief for a background agent, not a
pointer to a non-vendored document.
