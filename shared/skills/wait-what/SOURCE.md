# Skill source: wait-what

- **Repository:** [mattpocock/skills](https://github.com/mattpocock/skills)
- **Path in the repository:** `skills/productivity/wait-what`
...
Thin by design in the source: one sentence. It reads the project's own `CONTEXT.md` (and
`CONTEXT-MAP.md` when there is more than one), not a file from the source repository.
